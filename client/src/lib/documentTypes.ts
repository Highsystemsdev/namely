...
// Master tag registry — all tags available for use in any document template
export const MASTER_TAGS: DocumentVariable[] = [
  nameVar,
  lenderVar,
  dateVar,
  accountNumberVar,
  ...
  valuationAmountVar,
  purchasePriceVar,
  { key: "loanAmount", label: "{loanAmount}", description: "Loan amount", example: "$500,000" },
  { key: "depositAmount", label: "{depositAmount}", description: "Deposit amount", example: "$50,000" },
  { key: "giftAmount", label: "{giftAmount}", description: "Gift amount", example: "$50,000" },
  { key: "donor", label: "{donor}", description: "Donor name", example: "Jane Smith" },
  { key: "creditScore", label: "{creditScore}", description: "Credit score", example: "750" },
  { key: "paymentType", label: "{paymentType}", description: "Payment type", example: "Family Tax Benefit" },
  { key: "amount", label: "{amount}", description: "General amount", example: "$1,200" },
  { key: "salary", label: "{salary}", description: "Annual salary", example: "$85,000" },
  { key: "netPay", label: "{netPay}", description: "Net pay amount", example: "$4,200" },
  { key: "packagingAmount", label: "{packagingAmount}", description: "Salary packaging amount", example: "$9,000" },
  { key: "gstOwed", label: "{gstOwed}", description: "GST owed", example: "$5,000" },
  { key: "period", label: "{period}", description: "Period (e.g. quarter)", example: "Q4 2022-23" },
  { key: "state", label: "{state}", description: "Issuing state", example: "NSW" },
  { key: "nationality", label: "{nationality}", description: "Nationality", example: "Australian" },
  { key: "visaType", label: "{visaType}", description: "Visa type/subclass", example: "Subclass 482" },
  { key: "taxPayable", label: "{taxPayable}", description: "Tax payable", example: "$18,000" },
